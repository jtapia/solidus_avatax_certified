...
module SolidusAvataxCertified
  class Configuration < Spree::Preferences::Configuration
    ...
    preference :environment,
               :string,
               default: proc { SolidusAvataxCertified::Configuration.default_environment }
    ...
    preference :address_validation_enabled_countries,
               :array,
    ...
    preference :refuse_checkout_address_validation_error,
               :boolean,
               default: false
    ...
    def self.boolean_preferences
      %w(
        ...
        log_to_stdout
        address_validation
        refuse_checkout_address_validation_error
